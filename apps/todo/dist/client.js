var U=e=>{throw TypeError(e)};var V=(e,t,o)=>t.has(e)||U("Cannot "+o);var p=(e,t,o)=>(V(e,t,"read from private field"),o?o.call(e):t.get(e)),N=(e,t,o)=>t.has(e)?U("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,o);var A=(e,t,o)=>(V(e,t,"access private method"),o);let k=null,O=0;const F=new Set;function q(e){let t=e;const o=new Set;return{get(){return k!==null&&(o.add(k),k.deps.add(o)),t},set(n){console.log(n),!Object.is(t,n)&&(t=n,de(o))},peek(){return t}}}function $(e){let t=null;const o=()=>{n();const s=k;k=o,o.deps=new Set;try{const r=e();typeof r=="function"&&(t=r)}finally{k=s}};o.deps=new Set;function n(){t!==null&&(t(),t=null),o.deps.forEach(s=>{s.delete(o)}),o.deps.clear()}return o(),{dispose(){n()}}}function M(e){const t=q(le(e));return $(()=>{t.set(e())}),{get:()=>t.get(),peek:()=>t.peek()}}function P(e){O++;try{e()}finally{if(O--,O===0){const t=new Set(F);F.clear(),t.forEach(o=>{o()})}}}function le(e){const t=k;k=null;try{return e()}finally{k=t}}function de(e){e.size!==0&&(O>0?e.forEach(t=>{F.add(t)}):[...e].forEach(t=>{t()}))}const Z=Symbol("nf.ref");function ae(){return{[Z]:!0,el:null}}function fe(e){return typeof e=="object"&&e!==null&&e[Z]===!0}const R=Symbol("nf.directive");function K(e){return typeof e=="object"&&e!==null&&R in e&&e[R]===!0}const X="__NF__",ue=/^__NF__(\d+)$/,w=/__NF__(\d+)/g,z="@",H=".",Y=new WeakMap;let L=null;function ee(e,t){L=e;try{return t()}finally{L=null}}function pe(e,...t){return typeof window>"u"?be(e,t):he(e,t)}function he(e,t){let o=Y.get(e);o===void 0&&(o=ge(e),Y.set(e,o));const n=o.content.cloneNode(!0),s=me(n);for(const r of s){const i=t[r.index];i!==void 0&&ye(r,i)}return n}function ge(e){let t="";for(let n=0;n<e.length;n++)if(t+=e[n],n<e.length-1){const s=t.lastIndexOf("<"),r=t.lastIndexOf(">");s>r?t+=`${X}${n}`:t+=`<!--${X}${n}-->`}const o=document.createElement("template");return o.innerHTML=t,o}function me(e){const t=[],o=document.createTreeWalker(e,NodeFilter.SHOW_COMMENT|NodeFilter.SHOW_ELEMENT);let n;for(;(n=o.nextNode())!==null;)if(n.nodeType===Node.COMMENT_NODE){const s=ue.exec(n.nodeValue??"");s!==null&&t.push({type:"content",node:n,index:parseInt(s[1]??"0",10)})}else if(n.nodeType===Node.ELEMENT_NODE){const s=n;for(const r of[...s.attributes])if(r.name.startsWith(z)){const i=w.exec(r.value);w.lastIndex=0,i!==null&&t.push({type:"event",node:s,index:parseInt(i[1]??"0",10),eventName:r.name.slice(z.length)})}else if(r.name.startsWith(H)){const i=w.exec(r.value);w.lastIndex=0,i!==null&&t.push({type:"prop",node:s,index:parseInt(i[1]??"0",10),propName:r.name.slice(H.length)})}else if(r.name==="ref"){const i=w.exec(r.value);w.lastIndex=0,i!==null&&t.push({type:"ref",node:s,index:parseInt(i[1]??"0",10)})}else{const i=w.exec(r.value);w.lastIndex=0,i!==null&&t.push({type:"attr",node:s,index:parseInt(i[1]??"0",10),attrName:r.name})}}return t}function ye(e,t){const o=L??$;switch(e.type){case"event":{typeof t=="function"&&e.node.addEventListener(e.eventName,t),e.node.removeAttribute(`${z}${e.eventName}`);break}case"prop":{e.node.removeAttribute(`${H}${e.propName}`);const n=s=>{e.node[e.propName]=s};typeof t=="function"?o(()=>{n(t())}):n(t);break}case"content":{const n=e.node;if(K(t)){t._apply(n,o);break}let s=[];const r=i=>{var d,h;for(const f of s)(d=f.parentNode)==null||d.removeChild(f);s=[];for(const f of te(i))(h=n.parentNode)==null||h.insertBefore(f,n),s.push(f)};typeof t=="function"?o(()=>r(t())):r(t);break}case"ref":{e.node.removeAttribute("ref"),fe(t)&&(t.el=e.node);break}case"attr":{typeof t=="function"?o(()=>{e.node.setAttribute(e.attrName,I(t()))}):e.node.setAttribute(e.attrName,I(t));break}}}function be(e,t){let o="";for(let n=0;n<e.length;n++){const s=e[n]??"";if(n<t.length){const r=t[n];if(/\s([@.][\w:-]+|ref)=["']?$/.test(s.trimEnd())){o+=s.replace(/\s([@.][\w:-]+|ref)=["']?$/,"");continue}o+=s;const d=typeof r=="function"?r():r;K(d)?o+=d._ssr():Array.isArray(d)?o+=d.map(h=>typeof h=="string"?h:G(I(h))).join(""):o+=G(I(d))}else o+=s}return o}function te(e){return e instanceof DocumentFragment?[...e.childNodes]:e instanceof Node?[e]:Array.isArray(e)?e.flatMap(te):[document.createTextNode(I(e))]}function I(e){return e==null?"":String(e)}function G(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}const D=new WeakMap,xe=new Map;function j(e,t,o={}){if(!e.includes("-"))throw new Error(`[nativeframe] Component name "${e}" must contain a hyphen (Custom Elements spec).`);const n={name:e,fn:t,options:{shadow:o.shadow??!0,shadowMode:o.shadowMode??"open",observedAttrs:o.observedAttrs??[],island:o.island??!1,onError:o.onError,styles:o.styles}};return xe.set(e,n),typeof window<"u"&&Ee(n),we(e)}function ke(e,t){if(document.querySelector(`style[data-nf="${e}"]`)!==null)return;const o=document.createElement("style");o.dataset.nf=e,o.textContent=`@scope (${e}) {
${t}
}`,document.head.appendChild(o)}function Ee(e){var i,d,h,f,m,B,oe,ne;const{name:t,fn:o,options:n}=e;if(customElements.get(t)!==void 0)return;!n.shadow&&n.styles!==void 0&&ke(t,n.styles);let s;if(n.shadow&&n.styles!==void 0)try{s=new CSSStyleSheet,s.replaceSync(n.styles)}catch{}class r extends HTMLElement{constructor(){super(...arguments);N(this,m);N(this,i,[]);N(this,d,[]);N(this,h,[]);N(this,f,[])}static get observedAttributes(){return n.observedAttrs}connectedCallback(){if(s!==void 0){const c=this.shadowRoot??this.attachShadow({mode:n.shadowMode});c.adoptedStyleSheets.includes(s)||(c.adoptedStyleSheets=[s,...c.adoptedStyleSheets])}A(this,m,B).call(this),p(this,d).forEach(c=>{c()})}disconnectedCallback(){p(this,i).forEach(c=>{c.dispose()}),p(this,i).length=0,p(this,h).forEach(c=>{c()});for(const c of p(this,f))c.el=null;p(this,f).length=0}attributeChangedCallback(c,l,a){l!==a&&A(this,m,B).call(this)}}i=new WeakMap,d=new WeakMap,h=new WeakMap,f=new WeakMap,m=new WeakSet,B=function(){var _;const c=n.shadow?this.shadowRoot??this.attachShadow({mode:n.shadowMode}):this;if(c.childNodes.length>0&&this.hasAttribute("nf-ssr")){this.removeAttribute("nf-ssr");return}for(const y of p(this,f))y.el=null;p(this,f).length=0;const l=A(this,m,ne).call(this),a=A(this,m,oe).call(this);if(n.shadow&&n.styles!==void 0&&s===void 0&&c.querySelector("style[data-nf]")===null){const y=document.createElement("style");y.dataset.nf=t,y.textContent=n.styles,c.appendChild(y)}const g=p(this,i).length;try{const y=ee(l.effect,()=>o(a,l));c.replaceChildren(y)}catch(y){for(let b=g;b<p(this,i).length;b++)(_=p(this,i)[b])==null||_.dispose();if(p(this,i).length=g,n.onError!==void 0){console.error(`[nativeframe] <${this.tagName.toLowerCase()}>:`,y);try{const b=n.onError(y);b instanceof DocumentFragment?c.replaceChildren(b):c.innerHTML=typeof b=="string"?b:String(b??"")}catch{c.innerHTML=""}}else throw y}},oe=function(){const c={};for(const a of this.attributes)if(a.name!=="nf-ssr")try{c[a.name]=JSON.parse(a.value)}catch{c[a.name]=a.value}const l=this._nfProps;return l!==void 0&&Object.assign(c,l),c},ne=function(){const c=this;return{signal(l){return q(l)},computed(l){return M(l)},batch:P,effect(l){const a=n.onError!==void 0?$(()=>{try{l()}catch(g){console.error(`[nativeframe] effect error in <${c.tagName.toLowerCase()}>:`,g)}}):$(l);return p(c,i).push(a),a},watch(l,a){let g,_=!1;const y=$(()=>{const b=l();if(!_){_=!0,g=b;return}a(b,g),g=b});p(c,i).push(y)},html:pe,onMount(l){p(c,d).push(l)},onUnmount(l){p(c,h).push(l)},provide(l,a){let g=D.get(c);g===void 0&&(g=new Map,D.set(c,g)),g.set(l._id,a)},inject(l){let a=c.parentElement;for(;a!==null;){const g=D.get(a);if(g!==void 0&&g.has(l._id))return g.get(l._id);a=a.parentElement}return l._defaultValue},ref(){const l=ae();return p(c,f).push(l),l}}},customElements.define(t,r)}function we(e){return t=>{if(typeof window>"u")return{[R]:!0,_apply(){},_ssr(){return`<${e}${ve(t)}></${e}>`}};const o=document.createElement(e);if(t){const n={};let s=!1;for(const[r,i]of Object.entries(t))i!=null&&(typeof i=="object"||typeof i=="function"?(n[r]=i,s=!0):o.setAttribute(r,String(i)));s&&(o._nfProps=n)}return o}}function ve(e){if(!e)return"";let t="";for(const[o,n]of Object.entries(e))n!=null&&(typeof n=="object"||typeof n=="function"||(t+=` ${o}="${String(n).replace(/"/g,"&quot;")}"`));return t}function Se(e,t,o){return{[R]:!0,_apply(n,s){const r=new Map;s(()=>{var m,v,J;const i=e(),d=i.map(t),h=new Set(d);for(const[E,T]of r)if(!h.has(E)){for(const S of T)(m=S.parentNode)==null||m.removeChild(S);r.delete(E)}let f=n;for(let E=i.length-1;E>=0;E--){const T=i[E],S=d[E];let c=r.get(S);if(c===void 0){const l=ee(s,()=>o(T,E));c=re(l),r.set(S,c);for(const a of c)(v=n.parentNode)==null||v.insertBefore(a,f)}else{const l=c[c.length-1];if(l!==void 0&&l.nextSibling!==f)for(const a of c)(J=n.parentNode)==null||J.insertBefore(a,f)}c.length>0&&(f=c[0])}})},_ssr(){return e().map((n,s)=>W(o(n,s))).join("")}}}function re(e){return e instanceof DocumentFragment?[...e.childNodes]:e instanceof Node?[e]:Array.isArray(e)?e.flatMap(re):[document.createTextNode(e==null?"":String(e))]}function W(e){return K(e)?e._ssr():typeof e=="string"?e:e==null?"":Array.isArray(e)?e.map(W).join(""):typeof e=="function"?W(e()):String(e)}function se(e){const t={};for(const s of Object.keys(e))t[s]=q(e[s]);const o=t;return{...o,derive(s){return M(()=>s(o))},update(s){P(()=>{for(const r of Object.keys(s)){const i=s[r];i!==void 0&&r in t&&t[r].set(i)}})},snapshot(){const s={};for(const r of Object.keys(t))s[r]=t[r].peek();return s},rehydrate(s){P(()=>{for(const r of Object.keys(s)){const i=s[r];i!==void 0&&r in t&&t[r].set(i)}})}}}const u=se({todos:[]}),ie="nf-todos";function Ne(){try{const e=localStorage.getItem(ie),t=JSON.parse(e??"null");u.todos.set(t??[])}catch{}}function $e(){$(()=>{localStorage.setItem(ie,JSON.stringify(u.todos.get()))})}const x=se({filter:"all",editingId:null});function _e(e){const t=e.trim();t&&u.todos.set([...u.todos.get(),{id:crypto.randomUUID(),text:t,done:!1}])}function ce(e){u.todos.set(u.todos.get().filter(t=>t.id!==e))}function Ae(e){u.todos.set(u.todos.get().map(t=>t.id===e?{...t,done:!t.done}:t))}function Q(e,t){const o=t.trim();o?u.todos.set(u.todos.get().map(n=>n.id===e?{...n,text:o}:n)):ce(e),x.editingId.set(null)}function Ce(){const e=u.todos.get(),t=e.length>0&&e.every(o=>o.done);u.todos.set(e.map(o=>({...o,done:!t})))}function Me(){u.todos.set(u.todos.get().filter(e=>!e.done))}j("todo-form",(e,{html:t})=>t`
    <style>
      :host { display: block; }
      form {
        display: flex;
  ...
  `);const Ie=M(()=>{const e=u.todos.get(),t=x.filter.get();return t==="active"?e.filter(o=>!o.done):t==="done"?e.filter(o=>o.done):e});let C=null;const Te=j("todo-item",(e,{html:t})=>{const o=e["todo-id"]??"",n=M(()=>u.todos.get().find(r=>r.id===o)),s=M(()=>x.editingId.get()===o);return t`
    ...
    <li
      ...
      @drop=${r=>{if(r.preventDefault(),C===null||C===o)return;const i=u.todos.get(),d=i.findIndex(v=>v.id===C),h=i.findIndex(v=>v.id===o);if(d===-1||h===-1)return;const f=[...i],[m]=f.splice(d,1);m!==void 0&&f.splice(h,0,m),u.todos.set(f),C=null}}
    >
      <button
        class="toggle"
        @click=${()=>{Ae(o)}}
      ...
      <span
        class="text"
        @dblclick=${r=>{x.editingId.set(o);const d=r.target.getRootNode().querySelector(".edit");d!==null&&requestAnimationFrame(()=>{d.focus()})}}
      >${()=>{var r;return((r=n.get())==null?void 0:r.text)??""}}</span>
      <input
        class="edit"
        type="text"
        .value="${()=>{var r;return((r=n.get())==null?void 0:r.text)??""}}"
        @keydown=${r=>{const i=r,d=r.target;i.key==="Enter"?Q(o,d.value):i.key==="Escape"&&(x.editingId.set(null),d.blur())}}
